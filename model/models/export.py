...
def export(weights='./yolov5s.pt',  # weights path
    ...
    img = torch.zeros(batch_size, *img_size,3).to(device)  # image size(1,3,320,192) iDetection
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'../runs/train/exp70/weights/polygon_last.pt', help='weights path')
