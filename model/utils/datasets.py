...
def create_dataloader(path, imgsz, batch_size, stride, single_cls=False, hyp=None, augment=False, cache=False, pad=0.0,
    ...
    dataloader = loader(dataset,
                        ...
                        sampler=sampler,
                        pin_memory=True,
                        collate_fn=custom_dataset_class.collate_fn4 if (
                                quad and not polygon) else custom_dataset_class.collate_fn)
...
# Polygon currently does not support cutout, crop
    ...
    def __init__(self):
        ...
        try:
            ...
            self.transform = A.Compose([
                A.MedianBlur(p=0.05),
                A.ToGray(p=0.7),
                A.RandomBrightnessContrast(p=0.7, brightness_limit=(-1.0, 1.0), contrast_limit=(-0.2, 0.2)),
                A.CLAHE(p=0.2),
                A.InvertImg(p=0.5)], )
