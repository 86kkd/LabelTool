...
class ComputeLoss:
    ...
    def build_targets(self, p, targets):
        ...
        for i in range(self.nl):
            ...
            gj_int=gj.clamp_(0, gain[3] - 1).long()
            gi_int=gi.clamp_(0, gain[2] - 1).long()
            indices.append((b, a, gj_int.clamp_(0, gain[3] - 1), gi_int.clamp_(0, gain[2] - 1)))   # image, anchor, grid indices  # image, anchor, grid indices
